...
class DeepSearchError(Exception):
    ...
    def __init__(self, message: str, failure_class: str = "permanent", retry_after_seconds: float = 0.0):
...
class TransientFailure(DeepSearchError):
    ...
    def __init__(self, message: str, retry_after_seconds: float = 1.0):
        super().__init__(message, failure_class="transient", retry_after_seconds=retry_after_seconds)
...
class RateLimitFailure(DeepSearchError):
    ...
    def __init__(self, message: str, retry_after_seconds: float = 5.0):
        super().__init__(message, failure_class="rate_limit", retry_after_seconds=retry_after_seconds)
...
class InvalidInputFailure(DeepSearchError):
    ...
    def __init__(self, message: str):
        super().__init__(message, failure_class="invalid_input", retry_after_seconds=0.0)
...
class AmbiguousSideEffectFailure(DeepSearchError):
    ...
    def __init__(self, message: str):
        super().__init__(message, failure_class="ambiguous_side_effect", retry_after_seconds=0.0)
