    ...
    for scenario in SEARCH_SCENARIOS:
        ...
        try:
            ...
            pdfs = [
                ...
                if f.get("type") == "pdf" or f.get("url", "").endswith(".pdf")
            ]
            ...
            summary = {
                ...
                "total_pdfs": len(pdfs),
                "unique_domains": manifest_data.get("summary", {}).get(
                    "total_unique_domains", 0
                ),
                "average_relevance": manifest_data.get("quality_report", {}).get(
            ...
            print(
                f"    [OK] Completed in {elapsed:.2f}s | Pages: {res.total_pages_processed} | Chunks: {res.total_rag_chunks} | Quality Gate: {res.quality_gate_passed}"
            )
